  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      if (showtime.startTime) {
        ...
        console.log('SeatSelectionModal: Using startTime:', showtime.startTime, '-> showDate:', showDate, 'showTime:', showTime);
      } else {
        showDate = showtime.showDate || new Date().toISOString().split('T')[0];
        showTime = showtime.time || showtime.showTime || new Date().toISOString();
        console.log('SeatSelectionModal: Using fallback dates - showDate:', showDate, 'showTime:', showTime);
      }
      ...
      console.log('SeatSelectionModal: Creating single ticket for multiple seats:', ticketData);

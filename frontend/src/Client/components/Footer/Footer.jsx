      ...
      <div className="footer-content">
        ...
        <div className="footer-section company-section">
          <div className="company-logo">
            <img className="company-logo-img" src="https://cdn.moveek.com/bundles/ornweb/img/favicon-large.png" alt="HAK Studio" />
          </div>

          <div className="company-info">
            <h3 className="company-name">HAK Studio Cineverse</h3>
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              <div>
                ...
                <p className="contact-value">CustomerCare@CINEVERSE.VN</p>
              </div>
            </div>

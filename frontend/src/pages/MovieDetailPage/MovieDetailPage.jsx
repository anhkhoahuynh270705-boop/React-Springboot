        ...
        <div className="movie-header-content">
          <div className="movie-info">
            <div className="movie-text-content">
              <h1 className="movie-title" style={{color: 'white'}}>{getTitle(movie)}</h1>
              {getEnglishTitle(movie) && (
                <p className="movie-subtitle">{getEnglishTitle(movie)} - {getGenres(movie)}</p>
              )}
              ...
              <div className="action-buttons">
                ...
                {movie.trailerUrl ? (
                  ...
                  <button className="action-btn trailer-btn" disabled>
                  <span>Trailer</span>
                </button>
                )}
                <button className="action-btn buy-ticket-btn">
                  <span>Mua vé</span>
                </button>
              </div>

              <p className="movie-description">{getDescription(movie)}</p>
              ...
              <div className="movie-details">
                <div className="detail-item">
                  ...
                  <div className="detail-value">{getRating(movie)}%</div>
                </div>
                <div className="detail-item">
                  <div className="detail-header">
                    <Calendar size={16} />
                  ...
                  <div className="detail-value">{getReleaseDate(movie)}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-header">
                    <Clock size={16} />
                  ...
                  <div className="detail-value">{getDuration(movie)}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-header">
                    <User size={16} />
                  ...
                  <div className="detail-value">{getAgeRating(movie)}</div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'showtimes' && (
          <div className="showtimes-section">
            ...
            <div className="city-selection">
              ...
              />
              <button className="view-showtimes-btn">
                Xem lịch chiếu
              </button>
            </div>
          </div>
        ...
        {activeTab === 'info' && (
          <div className="info-section">
            <div className="movie-full-info">
              {/* Trailer embed */}
              <div className="trailer-embed-section">
                <div className="video-player">
                  {movie.trailerUrl ? (
                    <iframe
                      src={movie.trailerUrl}
              ...
              <div className="related-articles">
                ...
                {articlesLoading ? (
                  <div className="loading-message">Đang tải bài viết liên quan...</div>
                ) : articlesError ? (
                  <div className="error-message">{articlesError}</div>
                ) : relatedArticles.length === 0 ? (
                  <div className="no-articles-message">Chưa có bài viết liên quan nào</div>
                ) : (
                  <div className="articles-grid">
                    {relatedArticles.map((item) => (
                      <a className="article-card" key={item.id} href={item.href || item.url || '#'}>
                        ...
                        <div className="article-content">
                          ...
                          <span className="article-source">{item.source || item.author || 'Nguồn'}</span>
                          <p className="article-excerpt">{item.excerpt || item.summary || item.description}</p>
                        </div>
                      </a>
                    ))}
                  </div>
              ...
              <div className="community-section">
                ...
                {reviewsError && (
                  <div className="error-message">
                    <p>{reviewsError}</p>
                    <button onClick={fetchCommunityReviews} className="retry-btn">
                      Thử lại
                    </button>
                  </div>
                )}
                      ...
                      communityReviews.slice(0, 3).map((review) => (
                        <div className="review-card" key={review.id}>
                          <div className="review-header">
                            ...
                            <button className="share-comment-btn">
